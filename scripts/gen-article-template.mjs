...
const REF = "dist/australia-study-agent-free-consultation-comparison-2026/index.html"; // 参考页（已构建产物里的一篇真实文章页）
const SEG = "";
const DEFAULT_OG = "https://compare.org.cn/og-image.jpg"; // 站点默认 og 图（绝对 URL，可为空串）
